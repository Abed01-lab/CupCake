...
//    (4,'someone@nowhere.com','sesam','customer');
    ...
    public void testLogin01() throws LoginSampleException {
        // Can we log in
        Useres useres = UsersMapper.login( "jens@somewhere.com", "jensen" );
        assertTrue( useres != null );
    }

    @Test( expected = LoginSampleException.class )
    public void testLogin02() throws LoginSampleException {
        // We should get an exception if we use the wrong password
        Useres useres = UsersMapper.login( "jens@somewhere.com", "larsen" );
    }
    ...
    public void testLogin03() throws LoginSampleException {
        ...
        Useres useres = UsersMapper.login( "jens@somewhere.com", "jensen" );
        assertEquals( "customer", useres.getRole() );
    }
    ...
    public void testCreateUser01() throws LoginSampleException {
        ...
        Useres original = new Useres( "king@kong.com", "uhahvorhemmeligt", "konge" );
        UsersMapper.createUser( original );
        Useres retrieved = UsersMapper.login( "king@kong.com", "uhahvorhemmeligt" );
